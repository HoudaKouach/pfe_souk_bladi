...
import { Pagination, Autoplay } from 'swiper/modules'; // Importation du module Autoplay
import 'swiper/css';
        ...
        <div className="space-y-8">
          ...
          <div className=" bg-[#B5C18E] rounded-lg overflow-hidden">
            <Swiper
              ...
              autoplay={{
                delay: 5000, // Temps avant de passer à la slide suivante (en ms)
                disableOnInteraction: false, // La pagination ne sera pas désactivée lors des interactions
              }}
              modules={[Pagination, Autoplay]} // Ajout du module Autoplay
            ...
            >
              ...
              <SwiperSlide>
                <div className="flex flex-wrap items-center p-6">
                  ...
                  <div className="w-full md:w-5/12">
                    <img src="images/Tapis.png" alt="Tapis berbère" className="w-full h-auto" />
                  </div>
                </div>
              </SwiperSlide>
              ...
              <SwiperSlide>
                <div className="flex flex-wrap items-center p-6">
                  ...
                  <div className="w-full md:w-5/12">
                    <img src="images/olives-huil.png" alt="Huile d'olive" className="w-5/12 h-auto " />
                  </div>
                </div>
              </SwiperSlide>
            </Swiper>
